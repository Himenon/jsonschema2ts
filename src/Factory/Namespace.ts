...
export const findStatement = (context: Context): Factory["findNamespace"] => (params: Params$FindStatement): ts.Statement | undefined => {
...
export const create = ({ factory }: Context): Factory["create"] => (params: Params$Create): ts.ModuleDeclaration => {
...
export const createMultiple = (context: Context): Factory["createMultiple"] => (params: Params$CreateMulti): ts.ModuleDeclaration => {
...
export const update = (context: Context): Factory["update"] => (params: Params$Update): ts.ModuleDeclaration => {
...
export const addStatements = (context: Context): Factory["addStatements"] => (params: Params$Update): ts.ModuleDeclaration => {
  const { factory } = context;
  const { node, statements } = params;
  if (node.body && ts.isModuleBlock(node.body)) {
